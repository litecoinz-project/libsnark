...
public:
    ...
    void generate_r1cs_witness(const uint64_t address, const merkle_authentication_path &path);
    merkle_authentication_path get_authentication_path(const uint64_t address) const;
};
